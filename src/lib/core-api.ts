...
export type CoreProfileSettings = { theme: 'paper' | 'warm' | 'gray' | 'dark'; fontSize: number; lineHeight: number; editorWidth: 'narrow' | 'comfortable' | 'mobile' | 'document' | 'wide'; leftColumnWidth: number; rightColumnWidth: number; updatedAt: string };
