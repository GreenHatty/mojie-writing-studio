...
import { createD1ProfileSettingsStore } from './d1-store';
import { createProfileSettingsHandlers } from './handlers';

export function profileSettingsHandlersFromRuntime() {
  ...
  return createProfileSettingsHandlers({
    store: createD1ProfileSettingsStore(bindings.DB),
