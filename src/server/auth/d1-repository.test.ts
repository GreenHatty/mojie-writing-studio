...
describe('D1AuthRepository', () => {
  ...
  it('persists only the session token digest', async () => {
    ...
    await store.put({ tokenHash: 'digest-only', userId: 'u1', csrfState: 'csrf-only', createdAt: '2026-07-11T00:00:00Z', lastSeenAt: '2026-07-11T00:00:00Z', expiresAt: '2026-07-11T12:00:00Z', absoluteExpiresAt: '2026-07-18T00:00:00Z', revokedAt: null });
