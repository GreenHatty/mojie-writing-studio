...
import { createD1ChapterVersionStore } from './d1-store';
import { createChapterVersionHandlers } from './handlers';

export function chapterVersionHandlersFromRuntime() {
  ...
  return createChapterVersionHandlers({
    store: createD1ChapterVersionStore(bindings.DB),
