...
import { createD1ProjectEntityStore } from './d1-store';
import { createProjectEntityHandlers } from './handlers';

export function projectEntityHandlersFromRuntime() {
  ...
  return createProjectEntityHandlers({
    store: createD1ProjectEntityStore(bindings.DB),
