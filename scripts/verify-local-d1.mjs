...
const required = [
  ...
  'project_entities',
  'core_ranking_sources',
  'core_ranking_tasks',
  'core_ranking_snapshots',
  'core_publication_records',
  'backup_targets',
  'backup_runs',
  'backup_objects_v2'
];
...
process.stdout.write(`Local D1 migration acceptance passed (${required.length} core tables, singleton Owner, sync idempotency, digest-only sessions, and operations storage verified).\n`);
