...
run(['d1', 'execute', database, '--local', '--config', config, '--command', "DELETE FROM project_entities; DELETE FROM sync_operations; DELETE FROM chapters; DELETE FROM volumes; DELETE FROM works; DELETE FROM platform_accounts;", '--json']);
